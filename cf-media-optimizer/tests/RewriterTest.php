...
use CFMediaOptimizer\AttachmentLookup;
...
final class RewriterTest extends TestCase {
	...
	private function seed_attachment_alt( int $id, string $alt, bool $decorative = false ): void {
		$GLOBALS['cf_media_manager_test_post_meta'][ $id ][ AltMeta::META_KEY_ALT ] = $alt;
		if ( $decorative ) {
			$GLOBALS['cf_media_manager_test_post_meta'][ $id ][ AltMeta::META_KEY_DECORATIVE ] = '1';
		}
	}
