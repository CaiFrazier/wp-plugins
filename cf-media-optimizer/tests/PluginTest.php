...
final class PluginTest extends TestCase {
	...
	// Note: the pre-split cf-media-optimizer→cf-media-manager BACKFILL_DONE
	// repair (run_optimizer_migration) was dropped in the 3.0.0 split — the new
	// CF Media Optimizer reads existing cf_media_manager_* state directly and is
	// never misdetected as a fresh install, so no retroactive repair is needed.
}
